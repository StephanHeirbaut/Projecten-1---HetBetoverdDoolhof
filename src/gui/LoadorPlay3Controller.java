 ...
 * @author joche
 */
public class LoadorPlay3Controller extends Pane {
    ...
    public LoadorPlay3Controller(DomeinController dc)
    {
        btnPlay = new Button();
        this.dc = dc;
    ...
    @FXML
    private void btnLoadOnAction(ActionEvent event) throws Exception 
    {
        Stage s = (Stage) this.getScene().getWindow();
        LoadController root = new LoadController(dc);
